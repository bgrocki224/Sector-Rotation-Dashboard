...
def compute_current_scores(start_date: str, weights: dict):
    prices, volume, provider = load_data(start_date)
...
factors, scores, as_of = compute_current_scores(start_date, weights)
...
prices, _, _ = load_data(start_date)
